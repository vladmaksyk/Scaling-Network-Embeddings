...
def BFSRandomWalkWindow(startvertex, queue, queue_len, queue_pop_idx, queue_add_idx, context_pairs, window_size,
                        walk_lenght):
...
def Runner(wl,b,ows,input,output):
    ...
    for startvertex in adjdict.keys():
        ...
        BFSRandomWalkWindow(startvertex, queue, queue_len, queue_pop_idx, queue_add_idx, context_pairs, WINDOW_SIZE,
                            WALK_LENGHT)
